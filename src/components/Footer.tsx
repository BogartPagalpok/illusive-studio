  ...
  return (
    <footer className="relative bg-transparent overflow-visible mt-10 font-heading">
      <div className="section-container relative pb-12">
        ...
        >
          {/* WATERMARK: 15px above the line, Flush Right */}
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 items-start mb-16 md:mb-20">
            <div>
              ...
              <p className="text-[11px] mb-5 max-w-sm leading-relaxed text-white/60">{content?.hook_desc || "From brand systems to digital art — I bring ideas to life with precision and passion."}</p>
              
              {/* BUTTON: Aligned 15px above the flare line */}
              <div className="absolute bottom-[83px]">
