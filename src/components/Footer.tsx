    ...
    <footer className="relative bg-transparent overflow-hidden mt-10 font-heading">
      <div className="section-container relative pb-12">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start mb-16 gap-10">
            ...
            <div className="flex flex-col justify-between h-full min-h-[160px] lg:w-1/3 w-full">
              <div>
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase mb-3 leading-tight text-[var(--text-primary)] break-words w-full">
                  {content?.hook_heading || "Want to elevate your visual identity? Let's collaborate."}
                </h3>
                <p className="text-[11px] max-w-sm leading-relaxed text-[var(--text-secondary)]/60">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-10 w-full lg:w-2/3 lg:justify-items-end">
              ...
              <div className="flex flex-col">
                 <h4 className="text-[9px] uppercase tracking-widest mb-6 font-bold opacity-30 text-[var(--text-primary)]">Navigation</h4>
                 <ul className="space-y-4 text-[11px] text-[var(--text-primary)]/80 font-bold uppercase">
              ...
              {/* COLUMN 3: CONTACT */}
              <div className="flex flex-col">
                 <h4 className="text-[9px] uppercase tracking-widest mb-6 font-bold opacity-30 text-[var(--text-primary)]">Contact</h4>
                 <ul className="space-y-4 text-[11px] text-[var(--text-primary)]/80 font-bold">
                   <li>
              ...
              <div className="flex flex-col col-span-2 md:col-span-1">
                 <h4 className="text-[9px] uppercase tracking-widest mb-6 font-bold opacity-30 text-[var(--text-primary)]">Connect</h4>
                 <ul className="space-y-4 text-[11px] text-[var(--text-primary)]/80 font-bold">
                   <li><a href={content?.instagram} target="_blank" className="hover:text-accent flex items-center gap-3 transition-colors w-fit"><Instagram size={12} className="text-accent" /> Instagram</a></li>
                   <li><a href={content?.github} target="_blank" className="hover:text-accent flex items-center gap-3 transition-colors w-fit"><Github size={12} className="text-accent" /> GitHub</a></li>
                   <li><a href={content?.facebook} target="_blank" className="hover:text-accent flex items-center gap-3 transition-colors w-fit"><Facebook size={12} className="text-accent" /> Facebook</a></li>
                 </ul>
              </div>
          ...
          {/* WATERMARK: Kept exactly as you wanted */}
          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 opacity-60 text-[var(--text-primary)]">
              <button 
                onClick={() => { 
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <span className="opacity-30 text-[var(--text-primary)]">|</span>
                <a href="/terms" className="hover:text-accent transition-colors">Terms</a>
              </div>
            </div>

            <button onClick={() => window.scrollTo({top:0, behavior:'smooth'})} className="hover:text-accent transition-colors mt-2 md:mt-0 opacity-60 text-[var(--text-primary)]">
              Back to Top ↑
            </button>
          </div>
