...
// ── Sideways Flip Card (rotateY — no overlap) ────────────
  ...
  return (
    <>
      <div
        ...
        style={{ perspective: '1000px', backgroundColor: 'transparent' }}
      ...
      >
        ...
        >
          {/* Front — Image */}
          <div
            className="flip-card-front absolute inset-0 w-full h-full rounded-xl overflow-hidden border flex flex-col justify-end"
            style={{
          ...
          {/* Back — Details */}
          <div
            className="flip-card-back absolute inset-0 w-full h-full rounded-xl overflow-hidden border flex flex-col justify-center p-4"
            style={{
              backfaceVisibility: 'hidden',
              WebkitBackfaceVisibility: 'hidden',
          ...
          >
            <h3 className="font-black uppercase" style={{ fontSize: '1.2em', color: 'var(--text-primary)' }}>{project.title}</h3>
            {project.description && (
              <p className="text-xs mt-2 leading-relaxed" style={{ color: 'var(--text-secondary)' }}>{project.description}</p>
            )}
            {project.tools && (
