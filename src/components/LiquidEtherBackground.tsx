...
class FluidSimulation {
  ...
  advectionPass: any; externalForcePass: any; divergencePass: any;
  poissonPass: any; pressurePass: any; viscousPass: any; outputPass: any;

  constructor(options: any) {
    this.options = {
      iterationsPoisson: 16, iterationsViscous: 16, mouseForce: 20,
      resolution: 0.25, cursorSize: 100, viscous: 30, isBounce: false,
...
class AutoDriver {
  mouse: MouseTracker; enabled: boolean; speed: number; resumeDelay: number;
  active = false; current = new THREE.Vector2(); target = new THREE.Vector2();
  lastTime = performance.now(); private tmp = new THREE.Vector2();
