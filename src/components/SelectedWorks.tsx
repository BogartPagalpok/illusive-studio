  ...
  return (
    <section id="works" className="relative min-h-screen w-full bg-black overflow-hidden font-sans">
      ...
      <div className="relative z-10 h-screen min-h-[700px] flex flex-col px-6 md:px-16 py-8 md:py-12">
        ...
        {/* 3. HERO CONTENT - mt-auto pushes this down to sit right above the cards */}
            ...
            {currentProject && (
              ...
              >
                ...
                <div className="flex flex-wrap gap-3 md:gap-4">
                  ...
                  {/* Removed the Details button here per instructions */}
                </div>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          {filteredProjects.length > 0 ? (
            <>
              <Swiper
                ...
                spaceBetween={16}
                slidesPerView={'auto'}
                slidesOffsetAfter={60} /* Prevents the last card from being unreachable/unclickable */
                observer={true}
                observeParents={true}
        ...
        {selectedProject && (
          ...
          >
            <button 
              type="button"
              onClick={() => setSelectedProject(null)} 
              /* Dropped top-20 for mobile so it is not covered by the absolute/fixed navbar */
            ...
            <motion.div 
              ...
              /* Added actual Glassmorphism wrapper to the view project modal */
