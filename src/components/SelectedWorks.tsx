...
export default function SelectedWorks() {
  ...
  if (loading) return (
    <div className="h-[60vh] flex flex-col items-center justify-center bg-black gap-4">
      ...
      <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/40">Engine Online. Syncing...</p>
    </div>
  );
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[1000] flex items-center justify-center p-6 bg-black/95 backdrop-blur-2xl">
            ...
            <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} exit={{ scale: 0.9 }} className="max-w-6xl w-full grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-left">
                ...
                <p className="text-white/60 mt-6 text-lg leading-relaxed">{selectedProject.description || "Experimental visual design."}</p>
              </div>
            </motion.div>
          </motion.div>
        )}
