...
export default function SelectedWorks() {
  ...
  return (
    <section className="relative z-40 bg-transparent min-h-[130vh] py-12 overflow-visible flex flex-col justify-center">
      {/* FIXED: Anchor for perfect center-scroll */}
        ...
        <div className="relative group overflow-visible">
          <Swiper
            ...
            coverflowEffect={{
              ...
              depth: 250,      // ELEGANT PERSPECTIVE
              modifier: 1,
              slideShadows: false,
            }}
            speed={900} // BUTTERY SMOOTH TRANSITION
              ...
              >
                {({ isActive }) => (
                  ...
                  >
                    ...
                    <div className={`absolute bottom-0 left-0 p-8 md:p-10 w-full z-50 transition-all duration-700 delay-100 ${isActive ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
