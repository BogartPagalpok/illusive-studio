          ...
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-black/95 backdrop-blur-xl">
            ...
            <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-white/60 mt-6 text-lg leading-relaxed font-light">{selectedProject.description || "Experimental visual execution."}</p>
                <button className="mt-10 btn-primary px-10 py-4 font-black uppercase text-xs">View Project</button>
              </div>
            </div>
          </div>
        )}
