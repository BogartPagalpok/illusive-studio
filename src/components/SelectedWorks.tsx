...
export default function SelectedWorks() {
  ...
  return (
    <section id="works" className="selected-works-container relative h-screen w-full bg-[#050505] overflow-hidden flex flex-col justify-end">
      ...
      {/* CSS RESET FOR VERCEL BUILD SAFETY */}
      <style dangerouslySetInnerHTML={{ __html: `
        /* Hide Navbar when in this section */
        .selected-works-container:hover ~ nav, 
        .selected-works-container ~ nav {
